...
sudo chown hoge ~/go/src/github.com/future-architect
...
sudo sed -i 's/User root/User hoge/g' /etc/apache2/apache2.conf
sudo sed -i 's/Group root/Group hoge/g' /etc/apache2/apache2.conf
#awk
